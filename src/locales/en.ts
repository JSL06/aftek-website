const en = {
  ...
  'home.projects.viewAllButton': 'View All Projects',
  ...
  'projects.featuresTechnologies': 'Features & Technologies',
  ...
  'productDetail.relatedProductsDescription': 'These products are related to {productName} and may be of interest to you.',
  'productDetail.noRelatedProducts': 'No related products available for {productName} at the moment.',
  ...
  'admin.products.relatedProjects': 'Related Projects',
  'admin.products.selectedFeatures': 'Selected Features',
  'admin.products.clearAll': 'Clear All',
  'admin.products.selectAll': 'Select All',
  'admin.products.searchFeatures': 'Search features...',
  ...
  'admin.projects.backToProjects': 'Back to Projects',
  'admin.projects.editProject': 'Edit Project',
  'admin.projects.addProject': 'Add New Project',
  'admin.projects.currentSelection': 'Current Selection',
  'admin.projects.selectCategory': 'Select category',
  'admin.projects.duration': 'Duration',
  'admin.projects.projectValue': 'Project Value',
  'admin.projects.projectType': 'Project Type',
  'admin.projects.featuresTechnologies': 'Features & Technologies',
  'admin.projects.productsUsed': 'Products Used',
  'admin.projects.selectProduct': 'Select product',
  'admin.projects.addProduct': 'Add Product',
  'admin.projects.projectImage': 'Project Image',
  'admin.projects.galleryImages': 'Gallery Images',
  'admin.projects.currentGalleryImages': 'Current Gallery Images',
  'admin.projects.uploadMultipleImages': 'Upload multiple images to create a project gallery. The first image will be used as the main project image.',
  'admin.projects.settings': 'Settings',
  'admin.projects.showOnWebsite': 'Show on website',
  'admin.projects.displayOrder': 'Display Order',
  'admin.projects.save': 'Save',
  'admin.projects.saving': 'Saving...',
  'admin.projects.cancel': 'Cancel',
  'admin.projects.remove': 'Remove',
  'admin.projects.challenges': 'Project Challenges',
  'admin.projects.solutions': 'Solutions',
  'admin.projects.results': 'Project Results',
  'admin.projects.pageDescription': 'Manage construction projects and case studies',
  'admin.projects.noProjectsFound': 'No projects found. Add your first project to get started.',
  'admin.projects.addFirstProject': 'Add First Project',
  'admin.projects.loading': 'Loading projects...',
  'admin.projects.loadingProject': 'Loading project...',
  'admin.projects.projectNotFound': 'Project Not Found',
  'admin.projects.projectNotFoundDescription': 'The project you\'re looking for doesn\'t exist or has been deleted.',
  'admin.projects.activeStatus': 'Active Status',
  'admin.projects.activeDescription': 'Enable or disable this project on the website',
  'admin.projects.featuredStatus': 'Featured Status', 
  'admin.projects.featuredDescription': 'Show this project in the featured projects section',
  'admin.projects.displayOrderDescription': 'Lower numbers appear first in lists',
  ...
  'admin.media.description': 'Manage media files and resources',
  'admin.media.loading': 'Loading media...',
  'admin.media.saveChanges': 'Save Changes',
  'admin.media.saving': 'Saving...',
  'admin.media.totalMedia': 'Total Media',
  'admin.media.activeMedia': 'Active Media',
  'admin.media.pendingChanges': 'Pending Changes',
  'admin.media.mediaStatus': 'Media Status',
  'admin.media.toggleDescription': 'Toggle media to enable/disable',
  'admin.media.uploadMedia': 'Upload Media',
  'admin.media.mediaName': 'Media Name',
  'admin.media.mediaType': 'Media Type',
  'admin.media.mediaCategory': 'Media Category',
  'admin.media.mediaDescription': 'Media Description',
  'admin.media.mediaFile': 'Media File',
  'admin.media.mediaThumbnail': 'Media Thumbnail',
  'admin.media.editMedia': 'Edit Media',
  'admin.media.mediaDetails': 'Media Details',
  'admin.media.imagePreview': 'Image Preview',
  'admin.media.editDetails': 'Edit Details',
  'admin.media.descriptionLabel': 'Description',
  'admin.media.page': 'Page',
  'admin.media.public': 'Public (Show on website)',
  'admin.media.saveMedia': 'Save Media',
  'admin.media.cancel': 'Cancel',
  'admin.media.backToMedia': 'Back to Media',
  'admin.media.uploadNewMedia': 'Upload New Media',
  'admin.media.selectFile': 'Select File',
  'admin.media.fileSelected': 'File Selected',
  'admin.media.noFileSelected': 'No file selected',
  'admin.media.upload': 'Upload',
  'admin.media.close': 'Close',
  'admin.media.delete': 'Delete',
  'admin.media.confirmDelete': 'Are you sure you want to delete this media?',
  'admin.media.deleteSuccess': 'Media deleted successfully',
  'admin.media.deleteError': 'Error deleting media',
  'admin.media.updateSuccess': 'Media updated successfully',
  'admin.media.updateError': 'Error updating media',
  'admin.media.uploadSuccess': 'Media uploaded successfully',
  'admin.media.uploadError': 'Error uploading media',
  'admin.media.fileInfo': 'File Information',
  'admin.media.file': 'File',
  'admin.media.size': 'Size',
  'admin.media.dimensions': 'Dimensions',
  'admin.media.type': 'Type',
  'admin.media.editingAt': 'This image is being edited at',
  'admin.media.noMediaFound': 'No media files found',
  'admin.media.noDescription': 'No description',
  'admin.media.selectPage': 'Select a page...',
  'admin.media.descriptionPlaceholder': 'Enter description...',
